      ...
      <Row>
        ...
        <Col md={3} style={{textAlign:'center'}}>
         <div className="box-parent" >
               ...
               <Link to={'/course'}> <button >  <FaBookOpen/> Engineering </button></Link>
               <Link to={'/tutorials'}> <button >  <FaBookOpen/> Medical   </button></Link>
               <Link to={'/tutorials'}> <button >  <FaBookOpen/> Agriculture</button></Link>
               <Link to={'/tutorials'}> <button >  <FaBookOpen/> Buissness </button></Link>
               <Link to={'/tutorials'}> <button >  <FaBookOpen/>Law </button></Link>
         </div>
        </Col>
